...
const helpCards = [
    ...
    },
    {
        ...
        bgColor: "yellow",
        linkTo: "/gatos-para-adocao",
        linkText: "Ver Gatinhos para Adoção",
    },
    {
                    ...
                    <div className={styles.sectionContent}>
                        ...
                        <div className={styles.itemList}>
                            <p className={styles.sectionDescription}>
                                Nossos gatinhos precisam de itens para crescerem
